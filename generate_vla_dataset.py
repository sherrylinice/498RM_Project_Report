...
#            return self.obs["robot0_eef_quat"].copy()
    ...
    def save_sample(self, trial_idx, rgb_img, depth_img, instruction, waypoint_labels):
...
#            return False
    ...
    def run_generation_loop(self, num_trials, num_videos, start_index=0):
        ...
        print(f"Starting data generation for {num_trials} trials, beginning at index {start_index}...")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="The starting number for episode folders (e.g., 0, 1000, 2000)"
    )
    # --- END OF ADDITION ---
    ...
    generator.run_generation_loop(num_trials=args.num_trials,
